...
abstract class BaseBankForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'sectional_id' => new sfWidgetFormInputText(),
    ...
    $this->setValidators(array(
      ...
      'branch_id'    => new sfValidatorDoctrineChoice(array('model' => $this->getRelatedModelName('Branch'), 'required' => false)),
      'sectional_id' => new sfValidatorInteger(array('required' => false)),
